...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| acMH | 0.47 | 4.83 | 0.784 | 1.251 | 1.567 | 1.691 | 58.6 | 82 | 2/4 |
| SGLD | 0.12 | 2.15 | 0.605 | 3.096 | 4.916 | 5.904 | 11.3 | 110 | 0/4 |
| qSGLD | 0.51 | 4.98 | 0.797 | 1.209 | 1.620 | 2.270 | 20.0 | 114 | 0/4 |
| cycSGLD | 0.53 | 2.26 | 0.802 | 1.237 | 1.369 | 1.423 | 33.0 | 71 | 4/4 |
| SGHMC | 0.29 | 2.23 | 0.711 | 1.638 | 2.306 | 2.811 | 13.0 | 100 | 0/4 |
| **AWSGLD** | **0.61** | **2.12** | **0.824** | **1.026** | **1.057** | **1.080** | **123.7** | 71 | 4/4 |
...
- cutoff = 71 (AWSGLD 정상상태 에너지, 4체인 median). **ESS·Lowest U 는 4연쇄 평균(mean)** — strip 그림과 동일 집계.
- 연쇄별 ESS 예: AWSGLD random 연쇄 = 140(최고), acMH random 연쇄 = 24(최저) → AWSGLD의 init 강건성.
