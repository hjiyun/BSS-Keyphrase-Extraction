...
def main():
    ...
    json_path = os.path.join(out_dir, "awsgld_acmh_theta_recovery_summary_v2_moderate.json")
    png_path = os.path.join(out_dir, "awsgld_acmh_theta_recovery_summary_v2_moderate.png")
