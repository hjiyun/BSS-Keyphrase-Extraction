"""
Controlled simulation for comparing SGLD variants on theta / pi recovery.
...
4. The theta sampler arms use SGLD, qSGLD, and cycSGLD.

Run
---
python3 /home/jiyoon/3차/BSS-Keyphrase-Extraction-master/simlation/sgld_0504_easy.py
"""
...
def main():
    ...
    json_path = os.path.join(out_dir, "sgld_0504_easy_summary.json")
    png_path = os.path.join(out_dir, "sgld_0504_easy_summary.png")

    print("=" * 72)
    print("Controlled theta/pi recovery simulation: SGLD vs qSGLD vs cycSGLD")
    ...
    for r in range(R):
        ...
        for method in methods:
            ...
            print(
                f"[Trial {r+1}/{R}] {method:<7} | n_obs={result.n_obs} | "
