...
def grad_posterior_energy_fixed_btb(Y, alpha, theta, u_0, B, sigma2, BtB, batch_idx=None):
    """Gradient of energy = -gradient of log posterior, with precomputed B.T @ B.

    batch_idx=None → full-batch likelihood. batch_idx=array → minibatch (unbiased).
    """
    n = theta.shape[0]
